...
export interface ApiActionDeJeuActionDeJeu extends Struct.CollectionTypeSchema {
  collectionName: 'action_de_jeus';
  info: {
    displayName: 'Action de Jeu';
    pluralName: 'action-de-jeus';
    singularName: 'action-de-jeu';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::action-de-jeu.action-de-jeu'
    > &
      Schema.Attribute.Private;
    match: Schema.Attribute.Relation<'manyToOne', 'api::match.match'>;
    publishedAt: Schema.Attribute.DateTime;
    Temps: Schema.Attribute.Decimal;
    Type: Schema.Attribute.Enumeration<
      ['But', 'Assistance', 'P\u00E9nalit\u00E9']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMatchMatch extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    action_de_jeus: Schema.Attribute.Relation<
      'oneToMany',
      'api::action-de-jeu.action-de-jeu'
    >;
    Adversaire: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::match.match'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Score_adversaire: Schema.Attribute.Integer;
    Score_club: Schema.Attribute.Integer;
    Termine: Schema.Attribute.Boolean;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
